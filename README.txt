I have changed the schema into by adding "images" to the table accommodations as a column. Here is the new schema.

Use the one below

USE ephp001; -- CHANGE THIS TO USE YOUR DATABASE
